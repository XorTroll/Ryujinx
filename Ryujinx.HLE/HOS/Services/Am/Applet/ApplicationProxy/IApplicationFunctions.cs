...
using Ryujinx.HLE.HOS.Services.Am.Applet.Storage;
...
using AppletIStorage = Ryujinx.HLE.HOS.Services.Am.Applet.AppletProxy.IStorage;

namespace Ryujinx.HLE.HOS.Services.Am.Applet.ApplicationProxy
{
