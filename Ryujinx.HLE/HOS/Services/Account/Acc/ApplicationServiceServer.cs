...
namespace Ryujinx.HLE.HOS.Services.Account.Acc
{
    class ApplicationServiceServer
    {
        ...
        {
            context.ResponseData.Write(Horizon.Instance.Device.System.AccountManager.GetUserCount());
        ...
        public ResultCode GetUserExistenceImpl(ServiceCtx context)
        {
            ...
            context.ResponseData.Write(Horizon.Instance.Device.System.AccountManager.TryGetUser(userId, out _));
        ...
        {
            return WriteUserList(context, Horizon.Instance.Device.System.AccountManager.GetAllUsers());
        }

        public ResultCode ListOpenUsers(ServiceCtx context)
        {
            return WriteUserList(context, Horizon.Instance.Device.System.AccountManager.GetOpenedUsers());
        }
        ...
        {
            Horizon.Instance.Device.System.AccountManager.LastOpenedUser.UserId.Write(context.ResponseData);
        ...
        {
            if (Horizon.Instance.Device.System.AccountManager.GetUserCount() < 1)
            {
                // Invalid UserId.
            ...
            Horizon.Instance.Device.System.AccountManager.GetFirst().UserId.Write(context.ResponseData);
